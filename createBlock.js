...
let defaultExtensions = ['styl', 'pug', 'img']; // расширения по умолчанию
...
let styleManagerPath = './src/styles/style.styl';
    ...
    // Нет ошибки, поехали!
      ...
      extensions.forEach(function(extention){
        ...
        if (extention === 'styl') {
          ...
          let styleFileImport = `@import '../blocks/${blockName}/${blockName}.styl'`;
